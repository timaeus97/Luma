...
//    for (int i = 30; i < (TV.hres()); i ++) {
      ...
      TV.bitmap((TV.hres() * random(0,100)), random(1, 60), random(smile2, random(20,100)));
    ...
    TV.bitmap((TV.hres()) / 2 , 60, smile, random(0-30));
